...
/**
 * Created by hagiwara on 2018/03/10.
 */
...
public class AnswerSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    public void onClick(View v){
        ...
        DatabaseReference answerRef = databaseReference.child(Const.ContentPATH).child(String.valueOf(mQuestion.getGenre())).child(mQuestion.getQuestionUid()).child(Const.AnswersPATH);
